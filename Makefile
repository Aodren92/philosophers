...
SRCS_NAME = main.c philo_init.c philo_error.c philo_exit.c philo_main_loop.c\
			...
			philo_display_baguettes.c philo_renderer.c\
			philo_routine_philosophers.c philo_is_dead.c\
			philo_routine_philosophers_2.c\
			...
			philo_init_text.c philo_display_text.c philo_init_pos_name.c\
			philo_init_color.c philo_init_start.c philo_space_char.c\
			philo_display_timeout.c philo_display_conclusion.c
